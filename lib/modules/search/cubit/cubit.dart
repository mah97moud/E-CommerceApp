...
class SearchCubit extends Cubit<SearchSts> {
  SearchCubit() : super(InitSearchSt());
  ...
  void searchCourses({
    ...
    DioHelper.postData(
      ...
      emit(SuccessSearchSt());
      searchList = value.data['result']['data'];
    }).catchError((error) {
      emit(ErrorGetSearchSt());
